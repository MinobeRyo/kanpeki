...
音声取得・解析の初版は [AudioCapture](experiments/AudioCapture/README.md) で単体検証できます。[移植範囲と本体への統合点](docs/AUDIO_CAPTURE.md)・[進捗と残作業（Issue #12）](https://github.com/MinobeRyo/kanpeki/issues/12) を参照。本体iPhoneのメニュー→その他→確認・接続→「音声を試す」から録音・分析を検証できます。発表セッションとの統合と実機検証は未完了です。
