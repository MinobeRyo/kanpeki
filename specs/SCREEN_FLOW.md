...
2026-09-15更新：下部スライド直接操作、PPTXノート、タイマー・通知、カメラ・結果は部分実装済み。以下の表は目標遷移で全画面の完成を意味しない。現状は[STATUS](../docs/STATUS.md)、見本は[SCREEN_REVIEW](../docs/SCREEN_REVIEW.md)。QRは未マージPR #71、Mac準備再編はPR #67、簡素化はPR #70と区別する。
